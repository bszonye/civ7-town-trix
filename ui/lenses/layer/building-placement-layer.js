...
export class WorkerYieldsLensLayer {
    constructor() {
        ...
        this.YIELD_SPRITE_ANGLE = Math.PI / 3;  // 60°
        ...
        for (let i = 0; i < maxSlots; i++) {
            ...
            if (slot) {
                ...
                for (const [j, yieldIcon] of slot.yields.entries()) {
                    ...
                    const dy = this.YIELD_SPRITE_HEIGHT * Math.sin(this.YIELD_SPRITE_ANGLE);
                    const dz = this.YIELD_SPRITE_HEIGHT * Math.cos(this.YIELD_SPRITE_ANGLE);
